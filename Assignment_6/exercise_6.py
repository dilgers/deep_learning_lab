...
def create_config_space():
    ...
    adam_final_lr_fraction = CS.UniformFloatHyperparameter(
    ...
    adam_initial_lr = CS.UniformFloatHyperparameter(
		'Adam_initial_lr',
		lower=1e-4,
		upper=1e-2,
		default_value=1e-3,
    ...
    sgd_final_lr_fraction = CS.UniformFloatHyperparameter(
    ...
    sgd_initial_lr = CS.UniformFloatHyperparameter(
		'SGD_initial_lr',
		lower=1e-3,
		upper=0.5e0,
		default_value=1e-1,
    ...
    sgd_momentum = CS.UniformFloatHyperparameter(
		'SGD_momentum',
		lower=0.0,
		upper=0.99,
		default_value=0.9,
    ...
    stepdecay_epochs_per_step = CS.CategoricalHyperparameter(
    ...
    dropout_0 = CS.UniformFloatHyperparameter(
		'dropout_0',
		lower=0.0,
		upper=0.5,
		default_value=0.0)
    cs.add_hyperparameter(dropout_0)
    dropout_1 = CS.UniformFloatHyperparameter(
		'dropout_1',
		lower=0.0,
		upper=0.5,
		default_value=0.0)
    cs.add_hyperparameter(dropout_1)
    dropout_2 = CS.UniformFloatHyperparameter(
		'dropout_2',
		lower=0.0,
		upper=0.5,
		default_value=0.0)
    cs.add_hyperparameter(dropout_2)
    dropout_3 = CS.UniformFloatHyperparameter(
		'dropout_3',
		lower=0.0,
		upper=0.5,
		default_value=0.0)
    cs.add_hyperparameter(dropout_3)
    l2_reg_0 = CS.UniformFloatHyperparameter(
		'l2_reg_0',
		lower=1e-6,
		upper=1e-2,
		default_value=1e-4,
    ...
    l2_reg_1 = CS.UniformFloatHyperparameter(
		'l2_reg_1',
		lower=1e-6,
		upper=1e-2,
		default_value=1e-4,
    ...
    l2_reg_2 = CS.UniformFloatHyperparameter(
		'l2_reg_2',
		lower=1e-6,
		upper=1e-2,
		default_value=1e-4,
    ...
    l2_reg_3 = CS.UniformFloatHyperparameter(
		'l2_reg_3',
		lower=1e-6,
		upper=1e-2,
		default_value=1e-4,
    ...
    num_units_0 = CS.CategoricalHyperparameter(
		'num_units_0',
		[2**x for x in range(4, 9)],
		default_value=32)
    cs.add_hyperparameter(num_units_0)
    num_units_1 = CS.CategoricalHyperparameter(
		'num_units_1',
		[2**x for x in range(4, 9)],
		default_value=32)
    cs.add_hyperparameter(num_units_1)
    num_units_2 = CS.CategoricalHyperparameter(
		'num_units_2',
		[2**x for x in range(4, 9)],
		default_value=32)
    cs.add_hyperparameter(num_units_2)
    num_units_3 = CS.CategoricalHyperparameter(
		'num_units_3',
		[2**x for x in range(4, 9)],
		default_value=32)
    ...
    output_activation = CS.CategoricalHyperparameter(
		'output_activation',
		['softmax'],
